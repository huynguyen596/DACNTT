        ...
        <section class="hero bg-image" data-image-src="images/img/main.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Foodie </h1>
                    <h5 class="font-white space-xs">Find your favorite dishes and flavors</h5>
        ...
        <div class="sectionContent container">
           <div class="sectionIntro">
               <div class="headerInfo">
                   <h2 class="title">Our Journey of Flavor Since 2000</h2>
                   <p class="subTitle">We've been bringing the best flavors to your table for over 20 years. Crafted with passion, every dish is made from fresh, quality ingredients to create unforgettable meals. Join us on this journey of taste and make every bite count!</p>
               </div>
           </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="title-block pull-left">
                            <h4 class= "title">Restaurants</h4> </div>
                    </div>
                    <div class="col-sm-8">
															...
															<div class="row">
																...
																<div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
																	...
																	<div class="bottom-part">
																		<div class="cost"><i class="fa fa-check"></i> Min $5.00</div>
        ...
        <div class="footerIntro">
            ...
            <div class="footContactDetails">
                <div class="info">
                    ...
                    <span>foodiesupport@gmail.com</span>
                </div>
                ...
                <div class="info">
                    ...
                    <span>Nghiem Xuan Yem, Dai Kim, Hoang Mai, Ha Noi, Viet Nam</span>
                </div>
            </div>
        </div>
